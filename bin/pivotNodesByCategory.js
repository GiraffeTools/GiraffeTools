...
const getRainbowColor = index => {
  ...
  var g = Math.floor(
    Math.sin(1 * Math.PI * index + (2 * Math.PI) / 3) * 127 + 128
  );
  var b = Math.floor(
    Math.sin(1 * Math.PI * index + (4 * Math.PI) / 3) * 127 + 128
  );
