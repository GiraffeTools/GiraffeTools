  ...
  render() {
    ...
    return (
      <div className="parent">
        ...
        {/*
        <div id="camdiv">
          <a-scene className="scene" embedded arjs='trackingMethod: best; debugUIEnabled:false'>
            <a-assets>
            ...
            <a-marker model-overrider preset='custom' type='pattern' url='/static/img/patt/pattern-marker.patt'>
